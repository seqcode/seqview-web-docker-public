...
export default (Component, options) => {
  const wrapper = class RTSelectTable extends React.Component {
    ...
    render() {
      ...
      console.log("In render selectTable", selectType, keyField)

      const select = {
        id: '_' + selectType + '_selector',
        accessor: () => 'x', // this value is not important
        Header: this.props.columnHeader,
        Cell: ci => {
      ...
      return <Component {...rest} keyField={keyField} {...extra} ref={r => (this.wrappedInstance = r)} />
    }
  }
